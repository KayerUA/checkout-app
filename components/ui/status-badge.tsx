...
const statusTone: Record<string, string> = {
  ...
  BANK_TRANSFER_PAID: "border-emerald-200 bg-emerald-50 text-emerald-700",
  READY_TO_FULFILL_AFTER_BANK_PAYMENT: "border-emerald-200 bg-emerald-50 text-emerald-700",
  PAYMENT_MATCHED: "border-emerald-200 bg-emerald-50 text-emerald-700",
