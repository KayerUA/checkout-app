...
(function () {
  ...
  function injectB2BBlock() {
    ...
    block.innerHTML =
      ...
      '<p style="font-size:12px;line-height:1.4;color:#555;margin:8px 0 0;">Для покупок від ФОП або компанії рекомендуємо оплату за рахунком з підприємницького/юридичного рахунку.</p>' +
    ...
    block.addEventListener("change", function () {
      ...
      warning.style.display =
        isFop && getFieldValue("payment_preference") === "card" ? "block" : "none";
